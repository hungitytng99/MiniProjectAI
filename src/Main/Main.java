...
public class Main {
	...
	ImageIcon picture = new ImageIcon("maze.png");
	...
	public static final int buttonPostionY = screenHeight - 70;
	...
	public Main() {
		...
		// Display Picture
		imageLabel.setBounds(170, 150, 217, 165);
		imageLabel.setVisible(true);
		MenuWindow.add(imageLabel);
